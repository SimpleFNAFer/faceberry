...
#ifndef FACEBERRY_OPENCV_FUNCTIONS_H
#define FACEBERRY_OPENCV_FUNCTIONS_H
...
void addFace()
{
    ...
    if (!face_cascade.load("/home/student/faces_default"))
    {
        cout << "error" << endl;
        return ;
    };
...
void eigenFaceTrainer() {
    ...
    model->save("/home/student/eigenface.yml");
...
void  FaceRecognition() {
    ...
    model->read("/home/student/eigenface.yml");

    Mat testSample = imread("/home/student/0.jpg", 0);
    ...
    if (!face_cascade.load("/home/student/faces_default.xml")) {
...
#endif //FACEBERRY_OPENCV_FUNCTIONS_H
